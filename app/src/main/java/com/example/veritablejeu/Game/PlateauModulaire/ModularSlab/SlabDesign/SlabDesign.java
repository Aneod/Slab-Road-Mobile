package com.example.veritablejeu.Game.PlateauModulaire.ModularSlab.SlabDesign;
...
import com.example.veritablejeu.Game.PlateauModulaire.ModularSlab.SlabDesign.CercleDeCompte.CercleDeCompte;
...
public class SlabDesign {
    ...
    public void turnOff() {
        dalle.setBackground(CreateSimpleBackground.create(Color.LTGRAY, Color.BLACK, 1));
    }
