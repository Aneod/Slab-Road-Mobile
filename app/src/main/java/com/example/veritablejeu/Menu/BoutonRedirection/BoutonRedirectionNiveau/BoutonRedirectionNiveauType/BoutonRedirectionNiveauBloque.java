...
public class BoutonRedirectionNiveauBloque extends BoutonRedirectionNiveau {
     ...
     */
    public BoutonRedirectionNiveauBloque(@NonNull Context context, ListeDefilanteDeNiveaux parent, int width, int height, int leftMargin, int topMargin, LevelFile levelFile) {
