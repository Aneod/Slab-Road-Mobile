 ...
 */
public interface IPetiteFenetreFlottante2 {
     ...
     * Les propositions étants des {@link PetiteFenetreFlottante2.StringRunnablePair}.
     ...
     */
    void set(Point position, List<PetiteFenetreFlottante2.StringRunnablePair> liste);
