package com.example.veritablejeu.PopUp.ComposedComponents.Manuel.PageInstruction.ComposantsDePageInstruction.ParagrapheInstruction;

public interface IParagrapheInstruction {

    /**
     * Renvoie la hauteur actuelle de la classe.
     * @return un int.
     */
    int getHauteur();

    /**
     * Modifie la hauteur de la classe.
