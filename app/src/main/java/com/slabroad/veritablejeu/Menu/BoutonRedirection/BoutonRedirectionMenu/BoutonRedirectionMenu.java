...
import com.slabroad.veritablejeu.Menu.BoutonRedirection.BoutonRedirection;
...
public class BoutonRedirectionMenu extends BoutonRedirection implements IBoutonRedirectionMenu {
    ...
    public BoutonRedirectionMenu(
            @NonNull Context context, String titre,
            int width, int height, int leftMargin, int topMargin, int color) {
